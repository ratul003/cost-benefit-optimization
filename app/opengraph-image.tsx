  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", background: "#0a0a0f", padding: 90, position: "relative" }}>
        ...
        <div style={{ display: "flex", fontSize: 72, fontWeight: 800, color: "#fff", letterSpacing: -2, marginTop: 18, lineHeight: 1.05, maxWidth: 980 }}>{TITLE}</div>
        <div style={{ display: "flex", fontSize: 30, color: "#8888a8", marginTop: 28, maxWidth: 880, lineHeight: 1.4 }}>{SUB}</div>
        <div style={{ display: "flex", fontSize: 23, color: "#4a4a68", marginTop: 42 }}>Wahid Tawsif Ratul · BigQuery · R · Tableau</div>
      </div>
    ),
    { ...size },
  );
